...
export default function Todo({ list, title }) {
  ...
  return (
    <ol className="text-left bg-blue-400 mt-1 w-40 h-20 border-2 box-content border-sky-700/30 px-1 py-1 marker:text-blue-500  overflow-hidden font-inter list-disc text-black flex flex-col justify-evenly rounded-xl font-semibold">
