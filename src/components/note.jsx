...
export default function Note({ textblog, datenote, title, clickhandler, objectid, setnotedata, closehandler }) {
  return (
    <div onClick={clickhandler} data-id={objectid} className="w-44 cursor-pointer h-44 px-2 py-1 shadow-[2px_2px_0_black] border-2 relative  box-border border-black dark:border-white  text-left bg-red-500 overflow-hidden text-black">
